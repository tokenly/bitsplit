    ...
    <div class="welcome-section-content">
        ...
        <div class="how-it-works-row">
            <div class="how-it-works-row__panel">
                ...
                <!-- <p>
                    <span>Create a free Tokenpass account (powered by</span>
                    <a href="https://Tokenly.com">Tokenly</a><span>)</span>
                    <span>using just your email.</span>
                </p> -->
            </div>
        ...
        <div class="how-it-works-row">
            ...
            <div class="how-it-works-row__panel">
                ...
                <!-- <p>
                    <span>Add a</span>
                    <a href="https:://counterparty.io">Counterparty</a><span>-compatible</span>
                    <span>wallet address that holds the tokens you want to distribute.</span>
                </p> -->
            </div>
        ...
        <div class="how-it-works-row">
            <div class="how-it-works-row__panel">
               ...
               <!--  <p>Specify the name and amount of the token you want to distribute, the methodology to determine who shouldreceive your token, and more.</p> -->
            </div>
            <div class="how-it-works-row__panel centered">
        ...
        <div class="how-it-works-row">
            ...
            <div class="how-it-works-row__panel">
                ...
                <!-- <p>Review the details of your token distribution, including the number of recipients, total BTC fuel cost, and time/date of completion.</p> -->
            </div>
            <div class="how-it-works-row__panel centered mobile-only">
                <img src="{{ asset('img/distribution-details.PNG') }}" alt=""/>
            </div>
